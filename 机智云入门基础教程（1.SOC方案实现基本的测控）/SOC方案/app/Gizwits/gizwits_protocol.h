...
* @{
*/
#define PRODUCT_KEY "4f06a1c6645444c1bc23a8f66d392739"
/**@} */
/**@name Product Secret (Product key)
* @{
*/
#define PRODUCT_SECRET "83802576ac9d4290989373e71dac1af8"
...
#define color_controls_BYTEOFFSET                    0
#define color_controls_BITOFFSET                     2
#define color_controls_LEN                           4
...
typedef enum
{
    color_controls_VALUE0 = 0,//关闭
    color_controls_VALUE1 = 1,//自定义
    color_controls_VALUE2 = 2,//红色
    color_controls_VALUE3 = 3,//绿色
    color_controls_VALUE4 = 4,//蓝色
    color_controls_VALUE5 = 5,//黄色
    color_controls_VALUE6 = 6,//紫色
    color_controls_VALUE7 = 7,//粉色
    color_controls_VALUE8 = 8,//白色
    color_controls_VALUE_MAX,
} color_controls_ENUM_T;
