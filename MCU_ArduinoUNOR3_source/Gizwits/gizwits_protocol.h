...
* @{
*/
#define PRODUCT_KEY "acb0d3de1a9c498b84d9d9fa2c04629d"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "824051e0a65f4a758461332671e6b0be"
...
#define deng_BITOFFSET                     0
#define deng_LEN                           1

#define wenshidu_RATIO                         1
#define wenshidu_ADDITION                      0
#define wenshidu_MIN                           0
#define wenshidu_MAX                           100
/**@} */
